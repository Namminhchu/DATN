...
export class ManageProductsComponent implements OnInit {
  ...
  handlePageChange(event) {
    this.page = event;
    this.productService.getProductsByCategory(this.currentCategory, this.page, this.pageSize).subscribe(
        data => {
        ...
        error => {
          ...
          // Thực hiện xử lý lỗi, ví dụ như hiển thị thông báo cho người dùng
        }
    );
  }
