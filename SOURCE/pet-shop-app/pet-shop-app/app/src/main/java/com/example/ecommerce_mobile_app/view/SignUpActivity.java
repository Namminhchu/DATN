    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activitySignUpBinding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String phoneNumber = activitySignUpBinding.etPhoneNumber.getText().toString().trim();
                ...
                if (StringUtils.isBlank(signUpRequest.getUsername()) || StringUtils.isBlank(signUpRequest.getPassword())
                    ...
                    CustomToast.showFailMessage(getApplicationContext(), "Vui lòng nhập đúng số điện thoại");
                    return;
                }if (!email.matches("^[a-zA-Z0-9._%+-]+@(gmail\\.com|sv\\.hcmunre\\.edu\\.vn)$")) {
                    CustomToast.showFailMessage(getApplicationContext(), "Vui lòng nhập đúng định dạng email");
                    return;
