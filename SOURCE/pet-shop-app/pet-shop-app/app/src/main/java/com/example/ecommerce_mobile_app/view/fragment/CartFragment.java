...
public class CartFragment extends Fragment {
    ...
    public static void setTotalPrice(TextView textView, float price) {
        String format = String.format("%.2f", price) + " đ";
    ...
    public void clearCart() {
        if (Objects.isNull(order) || Objects.isNull(order.getId()) || mListCartItems == null || mListCartItems.isEmpty()) {
            CustomToast.showFailMessage(getContext(), "Your cart is empty!");
            return;
        }

// Các xử lý khác khi có sản phẩm trong giỏ hàng
