...
//            .create(APIService.class);
    ...
    Call<ResponseNormal<Customer>> getCustomerByEmail(@Path("email") String email);

    @POST("/user/update-password/{id}")
    Call<ResponseNormal<Customer>> updatePassword(@Path("id") int id, @Body UpdatePasswordRequest updatePasswordRequest);

    @POST("/forgotPassword")
    Call<LoginResponse> forgotPassword(@Body ForgotPasswordRequest forgotPasswordRequest);
    ...
    @GET("/service")
    Call<List<com.example.ecommerce_mobile_app.model.Service>> getAllServices();

    @GET("/worker")
    Call<List<com.example.ecommerce_mobile_app.model.Worker>> getAllWorkers();
    ...
    @POST("/booking")
    Call<ResponseNormal<Void>> book(@Body BookingService booking,
                                    @Header("Authorization") String authHeader);

    @GET("/booking/user/{user-id}")
    Call<List<BookingService>> getServiceByUser(@Path("user-id") Integer userId);
